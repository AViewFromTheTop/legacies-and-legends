...
execute as @a if items entity @s weapon.mainhand legacies_and_legends:tablet_of_revealing run function legacies_and_legends:use_effect/tablet_of_revealing
execute as @a if items entity @s weapon.offhand legacies_and_legends:tablet_of_revealing run function legacies_and_legends:use_effect/tablet_of_revealing
