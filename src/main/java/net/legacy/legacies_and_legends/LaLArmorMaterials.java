...
public interface LaLArmorMaterials {
    ...
    net.minecraft.world.item.equipment.ArmorMaterial TRAVELLING = new net.minecraft.world.item.equipment.ArmorMaterial(23, Util.make(new EnumMap(ArmorType.class), enumMap -> {
        enumMap.put(ArmorType.LEGGINGS, 3);
    }), 16, SoundEvents.ARMOR_EQUIP_LEATHER, 0.0F, 0.1F, LaLItemTags.REPAIRS_TRAVELLING_ARMOR, LaLEquipmentAssets.TRAVELLING);
